const wind = (uVector, vVector) => {
    ...
    let deg = xyAngleRad* 57.2957795;
    //let h = Math.sqrt(uVector**2 + vVector**2);
    let xyAngleRad2= (360*xyAngleRad)/(2*Math.PI)
    let x = (90 - 36)+180



    const a = { xyAngleRad: xyAngleRad,
                deg : deg,
                xyAngleRad2:xyAngleRad2,
                x : x
...
console.log("xy radian", wind(4, 3))
