...
<?xml version="1.0" encoding="UTF-8"?>
<wfs:FeatureCollection
    timeStamp="2024-01-24T17:56:09Z"
    numberMatched="1"
    numberReturned="1"
           xmlns:wfs="http://www.opengis.net/wfs/2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:om="http://www.opengis.net/om/2.0"
	...
	xmlns:target="http://xml.fmi.fi/namespace/om/atmosphericfeatures/1.1"
        ...
        http://xml.fmi.fi/namespace/om/atmosphericfeatures/1.1 https://xml.fmi.fi/schema/om/atmosphericfeatures/1.1/atmosphericfeatures.xsd">
    <wfs:member>
        <omso:PointTimeSeriesObservation gml:id="WFS-NENwWnpLFRRNONtRXeEgi1px0uSJTowqYWbbpdOt.Lnl5dsPTTv3c3Trvlw9NGXk6ddNO3L2w7OuXhh08oWliy59O6pp25bVH8KFw4d6GNj5c61ItCnHdOmjJq4Z2XdkqaduW1R_ChcOEP8JnZtunnpyc6zGLBi3cNXRry.e._lkv7.2Xl35aemHFsyxMzZh6ZefSJmbN.PDsy1qZtN.NJXdemZw1tuHxE08.mHdjy0rV0IDS24fEXhvx6Oc4Mcze25emXfQw8sO3L0y8udaHfnfYsNunc1tunnz07s9TL46VjTsM5tbuu2fmp9MPTTv3c5wmtx64dmnp5k7s2.Jrc.mHpp37qnnhlrQ38Mu7Jh6YW5z6b.WXJx65eXm_pyVphZtul0634ueXl2w9NO_dzdOu.XD00ZeTp1007cvbDs65eGHTyaHTTty0.mXhM0Omnbltb92WsarUhg-">
            <om:phenomenonTime>
                <gml:TimePeriod  gml:id="time1-1-1">
                    <gml:beginPosition>2024-01-24T05:56:00Z</gml:beginPosition>
                    <gml:endPosition>2024-01-24T17:56:00Z</gml:endPosition>
                </gml:TimePeriod>
            </om:phenomenonTime>
            <om:resultTime>
                <gml:TimeInstant gml:id="time2-1-1">
                    <gml:timePosition>2024-01-24T17:56:00Z</gml:timePosition>
                </gml:TimeInstant>
            </om:resultTime>
            <om:procedure xlink:href="http://xml.fmi.fi/inspire/process/opendata"/>
            <om:parameter>
            ...
            <om:observedProperty  xlink:href="https://opendata.fmi.fi/meta?observableProperty=observation&amp;param=ws_10min&amp;language=fin"/>
            <om:featureOfInterest>
                <sams:SF_SpatialSamplingFeature gml:id="fi-1-1-ws_10min">
                    <sam:sampledFeature>
                        <target:LocationCollection gml:id="sampled-target-1-1-ws_10min">
                            <target:member>
                                <target:Location gml:id="obsloc-fmisid-101785-pos-ws_10min">
                                    <gml:identifier codeSpace="http://xml.fmi.fi/namespace/stationcode/fmisid">101785</gml:identifier>
                                    <gml:name codeSpace="http://xml.fmi.fi/namespace/locationcode/name">Raahe Lapaluoto satama</gml:name>
                                    <gml:name codeSpace="http://xml.fmi.fi/namespace/locationcode/geoid">-16000190</gml:name>
                                    <gml:name codeSpace="http://xml.fmi.fi/namespace/locationcode/wmo">2872</gml:name>
                                    <target:representativePoint xlink:href="#point-fmisid-101785-1-1-ws_10min"/>
                                    <target:region codeSpace="http://xml.fmi.fi/namespace/location/region">Raahe</target:region>
                                </target:Location>
                            </target:member>
                        </target:LocationCollection>
                    ...
                    <sams:shape>
                        <gml:Point gml:id="point-fmisid-101785-1-1-ws_10min" srsName="http://www.opengis.net/def/crs/EPSG/0/4258" srsDimension="2">
                            <gml:name>Raahe Lapaluoto satama</gml:name>
                            <gml:pos>64.66589 24.40695 </gml:pos>
                        </gml:Point>
                    </sams:shape>
            ...
            <om:result>
                <wml2:MeasurementTimeseries gml:id="obs-obs-1-1-ws_10min">
                    ...
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T14:30:00Z</wml2:time>
                            <wml2:value>1.7</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T14:40:00Z</wml2:time>
                            <wml2:value>1.3</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T14:50:00Z</wml2:time>
                            <wml2:value>1.5</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:00:00Z</wml2:time>
                            <wml2:value>1.4</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:10:00Z</wml2:time>
                            <wml2:value>1.6</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:20:00Z</wml2:time>
                            <wml2:value>2.3</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:30:00Z</wml2:time>
                            <wml2:value>2.0</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:40:00Z</wml2:time>
                            <wml2:value>1.9</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T15:50:00Z</wml2:time>
                            <wml2:value>2.7</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:00:00Z</wml2:time>
                            <wml2:value>3.2</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:10:00Z</wml2:time>
                            <wml2:value>2.8</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:20:00Z</wml2:time>
                            <wml2:value>2.1</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:30:00Z</wml2:time>
                            <wml2:value>2.2</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:40:00Z</wml2:time>
                            <wml2:value>3.8</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T16:50:00Z</wml2:time>
                            <wml2:value>4.2</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:00:00Z</wml2:time>
                            <wml2:value>4.7</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:10:00Z</wml2:time>
                            <wml2:value>3.5</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:20:00Z</wml2:time>
                            <wml2:value>2.4</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:30:00Z</wml2:time>
                            <wml2:value>3.4</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:40:00Z</wml2:time>
                            <wml2:value>3.3</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                    <wml2:point>
                        <wml2:MeasurementTVP>
                            <wml2:time>2024-01-24T17:50:00Z</wml2:time>
                            <wml2:value>2.8</wml2:value>
                        </wml2:MeasurementTVP>
                    </wml2:point>
                </wml2:MeasurementTimeseries>
